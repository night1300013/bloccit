...
RSpec.describe QuestionsController, type: :controller do
  let(:my_q) { Question.create!(title: RandomData.random_sentence,\
  ...
  describe "POST create" do
    it "increases the number of Question by 1" do
      expect{post :create, params: { question: { title: RandomData.random_sentence,\
         body: RandomData.random_paragraph, resolved: [true, false].sample}}}.to \
         change(Question, :count).by(1)
    end

    it "assigns new question to @question" do
      post :create, params: { question: { title: RandomData.random_sentence,\
         body: RandomData.random_paragraph, resolved: [true, false].sample }}
  ...
  describe "PUT update" do
    it "updates question with expected attributes" do
      ...
      put :update, params: { id: my_q.id, question: { title: new_title, \
        body: new_body, resolved: new_resolved }}
